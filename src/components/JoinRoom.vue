<template>
  <div class="join-room flex flex-col bg-light-1 p-4 w-100 rounded font-mono">
    ...
    <div class="flex gap-2">
      ...
      <!-- <div class="flex gap-3"> -->
        <button 
          class="action w-40 p-2 mt-4 mx-auto rounded shadow-md text-light bg-blue-400 hover:opacity-95"
          @click="onJoin"
        >
          Join
        </button>
